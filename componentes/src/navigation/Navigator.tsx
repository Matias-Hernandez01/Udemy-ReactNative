...
import {InfinitiScrollScreens} from '../screens/InfinitiScrollScreens';
...
export const Navigator = () => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name="Animation101Screens"
        component={Animation101Screens}
      />
      <Stack.Screen
        name="Animation102Screens"
      ...
      <Stack.Screen
        name="PullToRefreshScreens"
        component={PullToRefreshScreens}
      />
      <Stack.Screen name="SectionListScreens" component={SectionListScreens} />
      <Stack.Screen name="ModalScreens" component={ModalScreen} />
      <Stack.Screen
        name="InfinitiScrollScreens"
        component={InfinitiScrollScreens}
      />
